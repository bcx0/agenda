...
export function MobileNav() {
  ...
  return (
    <nav className="safe-area-inset-bottom fixed bottom-0 left-0 right-0 z-50 border-t border-gray-800 bg-black/95 backdrop-blur md:hidden">
          ...
          return (
            <Link
              ...
              className={`touch-target flex h-full flex-1 flex-col items-center justify-center text-xs ${
                active ? "text-[#C8A060]" : "text-white/60"
              }`}
            >
              <Icon kind={link.icon} />
