...
export const translations = {
  ...
  "availability.addSlotTitle": { fr: "Ajouter un créneau", en: "Add a slot" },
  "availability.addSlotStart": { fr: "Début (heure belge)", en: "Start (Belgium time)" },
  "availability.addSlotEnd": { fr: "Fin", en: "End" },
  "availability.addSlotSubmit": { fr: "Ajouter le créneau", en: "Add slot" },
